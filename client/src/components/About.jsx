...
const About = () => {
    ...
    return (<>
        <section>
            {/* <div className='about-banner' style={{ backgroundImage: `url(data:image/png;base64,${base64Image})` }}> */}
            <div className='about-banner' style={{ backgroundImage: `url(/image/hero-banner.webp)` }}>
            ...
            <div className='container mb-5'>
                <div>
                    ...
                    <p>
                        Welcome to <strong style={{ color: "var(--han-blue)" }}>Braintube</strong>! We are a leading brand providing top-quality free courses across a wide range of fields. Whether you are looking to enhance your skills, develop new ones or just learn something new, we have something for everyone.
