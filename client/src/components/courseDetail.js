...
const CourseDetail = () => {
    ...
    const enrollCourse = async (userID) => {

        try {
            const res = await axios.post('/enroll', {courseId: userID});
    ...
    return (<>
        {data ? <><section className="course-detail py-4">
            <div className="container">
                ...
                <div className="row py-2">
                    <div className="col-lg-8 order-lg-1 order-2 py-3">
                        <h3>{data.name}</h3>
                        <h4>{data.lessons[0].lessonName}</h4>
                        ...
                        <p><i className="fa-solid fa-globe"></i>&nbsp;English, Hindi</p>
                    </div>
                    <div className="col-lg-4 order-lg-2 order-1 img-buy"><Link className="nav-link" to={"/"}>
                        <div className="overlay" style={{ maxWidth: "100%" }}><img src={require("../img/web-development.jpg")} alt="just new test text" style={{ width: "100%", minWidth: "300px" }} /></div>
                    </Link></div>
                </div>
            </div>
        </section>
        <section className="pt-4">
            <div className="container py-4">
                <h2 className="heading">List of Modules</h2>
                <ul>
                    <li>Item 1</li>
                    <li>Item 2</li>
                    <li>Item 3</li>
        ...
        <section>
            <div className="container">
                <h2 className="heading">This course includes</h2>
            </div>
        </section>
        <section>
            <div className="container">
