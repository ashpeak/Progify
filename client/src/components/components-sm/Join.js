                ...
                <div>
                    ...
                    <div className="pt-3">
                        <div className="row social-icon mb-2">
                            <div className="col-6 col-md-3 facebook"><a className="custom-link" href="#"><svg
                            ...
                            </svg></a><a className="custom-link" href="#">
                                    <p style={{ fontWeight: "700", color: "#0d6efd", fontSize: "x-large" }}>Facebook</p>
                                </a></div>
                            <div className="col-6 col-md-3 youtube"><a className="custom-link" href="#"><svg
                            ...
                            <div className="col-6 col-md-3 instagram"><a className="custom-link" href="#"><svg
